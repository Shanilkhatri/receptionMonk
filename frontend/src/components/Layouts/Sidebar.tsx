                ...
                <div className="bg-white dark:bg-black h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to={"/graph"}>{t("mockup")}</NavLink>
                                        </li>
                                        <li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'extension' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('extension')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('extension')}</span>
                                    </div>

                                    <div className={currentMenu === 'extension' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'extension' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/addext">{t('addext')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/viewext">{t('viewext')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'wallet' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('wallet')}>
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary" id="Capa_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className={currentMenu === 'wallet' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'wallet' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/addwallet">{t('addwallet')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/viewwallet">{t('viewwallet')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'calllog' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('calllog')}>
                                    <div className="flex items-center">
                                    <svg fill="currentColor" height="20" width="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                    ...
                                    <g>
                                        <g>
                                            <path d="M349.457,5.595c-83.85,0-158.466,39.362-206.531,100.555c10.804,8.218,19.77,19.126,27.009,29.602
                                                c40.681-55.016,105.99-90.775,179.522-90.775c123.055,0,223.164,100.115,223.164,223.164c0,89.692-53.205,167.136-129.697,202.574
                                                c8.618,10.371,16.166,21.916,20.459,34.032c87.94-42.421,148.62-132.428,148.62-236.606
                                                C612.003,123.143,494.461,5.595,349.457,5.595z"/>
                                            <path d="M405.15,469.257c-14.899-13.521-46.7-39.723-70.697-38.942c-7.857,0.256-14.696,3.361-20.905,7.161v-0.007
                                                ...
                                                c32.365,45.834,74.327,92.836,123.449,126.383c27.377,18.687,54.734,33.809,95.455,39.388c44.593,6.117,76.42-5.231,104.165-24.22
                                                c0.164-0.112,0.309-0.171,0.466-0.276c15.753-10.508,28.716-21.325,36.139-27.849c2.166-1.798,4.306-3.695,6.308-5.73
                                                c0.249-0.236,0.433-0.414,0.433-0.414l-0.02-0.026c4.306-4.476,8.27-9.603,9.445-16.403
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('calllog')}</span>
                                    </div>

                                    <div className={currentMenu === 'calllog' ? '!rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'calllog' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/addcalllog">{t('addcalllog')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/viewcalllog">{t('viewcalllog')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
