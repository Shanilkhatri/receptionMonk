                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            {isDarkMode ? (
                            <img className="w-24 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo/logo_dark.svg" alt="dark logo" />
                            ) : (
                            <img className="w-24 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo/logo_light.svg" alt="light logo" />
                            )}
                        </Link>
                        ...
                        <div className="dropdown shrink-0">
                            ...
                            >
                                <ul className="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    ...
                                    <li>
                                        <div className="p-4">
                                            <button className="btn btn-primary block w-full btn-small" onClick={() => setModal2(true)}> Two Factor Authentication</button>
                                        </div>
                                    </li>                                    
                                </ul>
                            </Dropdown>
                            ...
                            {/* <li onClick={(e) => e.stopPropagation()}>
                                ...
                                {notifications.length > 0 ? (
                                    <>
                                        ...
                                        <li>
                                            <div className="p-4">
                                                <button className="btn btn-primary block w-full btn-small">Two Factor Authentication</button>
                                            </div>
                                        </li>
                                    </>
                                ) : (
