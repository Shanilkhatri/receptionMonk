...
const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('Update Wallet'));
    });
            ...
            <div className='flex xl:flex-row flex-col gap-2.5 py-5'>
                <div className="panel px-0 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                    <div className="mt-8 px-4">
                        <div className='text-xl font-bold text-dark dark:text-white text-center'>Update Wallet</div>
                    ...
                    <div className="flex w-full pb-12">
                        <div className="flex items-center lg:justify-end lg:mr-6 w-1/2">                        
                            <button type="button" className="btn btn-outline-dark rounded-xl px-8 font-bold">RESET</button>
                        </div>
