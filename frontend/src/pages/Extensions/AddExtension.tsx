        ...
        <div>
            ...
            <div className='flex xl:flex-row flex-col gap-2.5 py-5'>
                ...
                <div className="mt-8 px-4">
                    <div className='text-xl font-bold text-dark dark:text-white text-center'>Add Extension</div>
                    <div className="flex justify-between lg:flex-row flex-col">
                        ...
                        <div className="lg:w-1/2 w-full m-8">
                            ...
                            <div className="flex items-center my-8">
                                ...
                                <input id="sip-pwd" type="sip-pwd" name="sip-pwd" className="form-input flex-1 border border-gray-400 focus:border-orange-400" placeholder="Enter Sip Password" />
                            </div>
                            <div className="flex items-center my-8">
