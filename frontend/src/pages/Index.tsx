        ...
        <div>
            ...
            <div className="pt-5">
                <div className="w-full h-full flex flex-col xl:flex-row gap-6">
                    <div className="w-full 2xl:w-2/3 xl:w-3/5"> 
                        <div className="panel overflow-hidden h-full shadow-md">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="dark:text-gray-300">Welcome Back!</div>
                                    <div className="text-2xl font-bold dark:text-gray-200">My Dashboard</div>
                                </div>
                                <div className="flex">
                                ...
                                <div className="flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 48 48" className="w-4 h-4 me-2">
                                        <path d="M 24 4 C 12.972066 4 4 12.972074 4 24 C 4 35.027926 12.972066 44 24 44 C 35.027934 44 44 35.027926 44 24 C 44 12.972074 35.027934 4 24 4 z M 24 7 C 33.406615 7 41 14.593391 41 24 C 41 33.406609 33.406615 41 24 41 C 14.593385 41 7 33.406609 7 24 C 7 14.593391 14.593385 7 24 7 z M 23.476562 11.978516 A 1.50015 1.50015 0 0 0 22 13.5 L 22 25.5 A 1.50015 1.50015 0 0 0 23.5 27 L 31.5 27 A 1.50015 1.50015 0 1 0 31.5 24 L 25 24 L 25 13.5 A 1.50015 1.50015 0 0 0 23.476562 11.978516 z" fill='currentColor'></path>
                                    </svg>
                                    <div className="text-xs font-bold">                                        
                                        15:25:56
                                    </div>
                            ...
                            <div className="relative mt-5">
                                <div className="grid md:grid-cols-3 gap-6 p-2 text-center">                                    
                                    <div className="flex flex-col justify-center items-center">
                                        ...
                                        <p className="font-semibold text-secondary text-2xl">John Miller</p>
                                    </div>
                                ...
                                <div className="panel h-full grid col-span-1 shadow-md space-y-5">
                                    <div className="flex">                                
                                        <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="font-semibold text-xl ps-3 pt-1 dark:text-white-light">Order Details</div>      
                                    </div>

                                    <div className="grid gap-8 text-sm text-[#515365] font-bold">                                    
                                        <div className='flex items-center justify-evenly'>
                                            <div className='text-center'>
                                                <div className='dark:text-gray-400'>Used Calls</div>
                                                <div className="text-[#04DC8B] text-xl sm:text-2xl">129</div>
                                            </div>                                       
                                            <div className='text-center'>
                                                <div className='dark:text-gray-400'>Decline Calls</div>
                                                <div className="text-danger text-xl sm:text-2xl">69</div>
                                            </div>
                                            <div className='text-center'>
                                                <div className='dark:text-gray-400'>Remaining Calls</div>
                                                <div className="text-info text-xl sm:text-2xl">57</div>
                                            </div>
                                            <div className="">
                ...
                <div className="grid sm:grid-cols-2 xl:grid-cols-4 md:grid-cols-2 gap-6 py-6">
                    <div className="panel h-full sm:col-span-2 md:col-span-1 shadow-md">                       
                ...
                <div className="grid col-span-12 pb-6">
                    <div className="panel h-full bg-secondary-light">
                        <div className="grid lg:grid-cols-12">
                            ...
                            <div className="grid lg:col-span-3 shadow-md">
                                <div className="panel">
                                    <div className="mb-5">
                                        ...
                                        <div className="flex justify-evenly">
                                            <div>
                                                <label className="flex items-center cursor-pointer">
                                                    ...
                                                    <span className="dark:text-gray-400">Answered</span>
                                                </label>
                                            </div>
                                            <div>
                                                <label className="flex items-center cursor-pointer">
                                                    <input type="radio" name="custom_radio2" className="form-radio" />
                                                    <span className="dark:text-gray-400">Missed</span>
                                                </label>
                                            </div>
                                        </div>                                    
