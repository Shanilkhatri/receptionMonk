                        ...
                        <Form className="space-y-5">
                            <div className='panel py-6 mt-8'>
                                <div className='p-4 my-8'>  
                                    <div className='text-xl font-bold text-dark dark:text-white text-center pb-12'>Add User</div>      
                                    <div className='grid lg:grid-cols-2 lg:space-x-12 lg:my-5'>
                                        <div className='grid md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userName ? 'has-error' : 'has-success') : ''}>
                                                <Field name="userName" type="text" id="userName" placeholder="Enter User Name" className="form-input flex-1 border border-gray-400 focus:border-orange-400" />
                                        ...
                                        <div className='grid md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userEmail ? 'has-error' : 'has-success') : ''}>
                                                <Field name="userEmail" type="text" id="userEmail" placeholder="Enter User Email" className="form-input flex-1 border border-gray-400 focus:border-orange-400" />
                                    ...
                                    <div className='grid lg:grid-cols-2 lg:space-x-12 lg:space-y-0 lg:my-5'>
                                        <div className='grid md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userPassword ? 'has-error' : 'has-success') : ''}>
                                                <Field name="userPassword" type="password" id="userPassword" placeholder="Enter User Password" className="form-input flex-1 border border-gray-400 focus:border-orange-400" />
                                        ...
                                        <div className='grid  md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userPhone ? 'has-error' : 'has-success') : ''}>
                                                <Field name="userPhone" type="text" id="userPhone" placeholder="Enter User Phone Number" className="form-input flex-1 border border-gray-400 focus:border-orange-400" />
                                    ...
                                    <div className='grid lg:grid-cols-2 lg:space-x-12 lg:space-y-0 lg:my-5'>
                                        <div className='grid md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userDob ? 'has-error' : 'has-success') : ''}>
                                                <Field name="userDob" type="date" id="userDob" className="form-input flex-1 border border-gray-400 focus:border-orange-400 text-gray-600" placeholder="Enter User Birth Date"  />
                                        ...
                                        <div className='grid  md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userAccType ? 'has-error' : 'has-success') : ''}>                                            
                                                ...
                                                <Field as="select" name="userAccType" className="form-select flex-1 border border-gray-400 focus:border-orange-400 text-gray-600">
                                    ...
                                    <div className='grid lg:grid-cols-2 lg:space-x-12 lg:space-y-0 lg:my-5'>
                                        <div className='grid md:grid-cols-2 my-3 lg:my-0'>
                                            ...
                                            <div className={submitCount ? (errors.userCompName ? 'has-error' : 'has-success') : ''}>
                                                <Field name="userCompName" type="text" id="userCompName" placeholder="Enter Company Name" className="form-input flex-1 border border-gray-400 focus:border-orange-400" />
                                    ...
                                    <div className="flex justify-center pt-6">
                                            <button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    else if (touched.userName && !errors.userEmail) {
                                                        submitForm();
                                                    }
                                                    else if (touched.userName && !errors.userPassword) {
                                                        submitForm();
                                                    }
                                                    else if (touched.userName && !errors.userPhone) {
                                                        submitForm();
                                                    }
                                                    else if (touched.userName && !errors.userDob) {
                                                        submitForm();
                                                    }
                                                    else if (touched.userName && !errors.userAccType) {
                                                        submitForm();
                                                    } 
                                                    else if (touched.userCompName && !errors.userDob) {
                                                        submitForm();
                                                    }
                                                    else if (touched.userStatus && !errors.userDob) {
                                                        submitForm();
                                                    }
                                                }}
                                            >
